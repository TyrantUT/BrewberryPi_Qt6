...
class RPiData : public QObject {
    ...
    Q_PROPERTY(float setpointTemp_Mash READ getSetpointTemp_Mash WRITE setSetpointTemp_Mash NOTIFY setpointTemp_MashChanged)
...
public slots:
    ...
    void setSetpointTemp_Mash(float value);
